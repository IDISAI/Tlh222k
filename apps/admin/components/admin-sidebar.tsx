...
export function AdminSidebar({ role }: { role: string | null }) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        <button
          ...
          className={cn(
            ...
            collapsed && "absolute top-4 left-14 z-10 bg-background shadow-sm"
          )}
        >
          {collapsed ? (
      ...
      <AdminNavigation collapsed={collapsed} role={role} />
      <div
        className={cn(
          "mt-auto border-t p-3 text-sm",
          collapsed && "grid place-items-center p-3"
        )}
      >
        <div className="flex items-center gap-2">
          ...
          {!collapsed && (
            <span>
              <b className="block text-xs">Administrator</b>
